 ...
 // 함수 선언문(기존에 알고 있던 함수)은 호이스팅 가능!(단어장 참고) 함수 표현식(화살표 함수)은 호이스팅 불가능!
...
const cat = {
  ...
  // 여기서 this의 전역은 foo1 function();인데 foo1에서 참조할 전역객체가 없기 때문에 결과 값이 undefined로 나온다.
  ...
  cat1.foo1();	// meow
  // 화살표 함수에는 this라는 변수 자체가 존재하지 않기 때문에 화살표 함수는 항상 상위 스코프의 this를 상속받는다.